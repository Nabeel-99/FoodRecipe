...
//   try {
//     const response = axios.get("http://localhost:8000/api/users/user")
    ...
    <div className="flex justify-between items-start w-screen py-6 px-2 md:px-12">
       ...
       <div className="hidden md:flex items-center gap-10">
        ...
        <div className={dropdown ? "absolute z-10 top-16 right-30 bg-gray-300 text-black h-48 w-36 rounded-md border border-black": "hidden"}>
          ...
          {/* <Link to="/" onClick={removeDropdrown}><button className="border border-gray-500 rounded-md w-28 text-black hover:border-gray-100">Home</button></Link>
