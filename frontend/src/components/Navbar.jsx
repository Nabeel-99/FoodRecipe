...
import {faBars, faMoon, faMagnifyingGlass, faUtensils, faXmark, faCircle} from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div className="flex justify-between items-start w-screen py-6 px-2 md:px-12">
       ...
       <div className="hidden md:flex items-center gap-10">
        <div><Link to="/signin" ><button className={lightMode ? "p-1 w-32 rounded-md bg-transparent border border-black" : "p-1 w-32 rounded-md bg-transparent border border-white"}>Sign in</button></Link></div>
...
export default Navbar
 {/*  <div className="text-left flex flex-col gap-3">
            ...
            <div>
              <button className="bg-transparent border-2 text-white bg-red-500 w-60 p-1 rounded-md">Delete Account</button>
            </div>
            <div>
              <button className="bg-transparent border-2 text-white bg-red-500 w-60 p-1 rounded-md">Log out</button>
            </div>
            <div>
              <FontAwesomeIcon icon={faGithub} className="w-7 h-7"/>
            </div>*/}