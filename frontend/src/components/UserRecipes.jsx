       ...
       {filteredRecipes.length > 0 ? filteredRecipes.map((recipe) => 
            (
             <div className="flex flex-col shadow-2xl rounded-br-xl rounded-bl-xl bg-gray-200" key={recipe._id} >
                 <Link><img src={recipe.recipeImage} className="object-cover w-[390px] h-[268px] border-r-2 border-l-2 border-t-2 border-white rounded-tl-md rounded-tr-md " alt="food image"/></Link>
                 <div className="p-1">
                    <p className="font-semibold text-xs text-black">{recipe.title}</p>
                </div>
                <div className="p-1">
                    <p className="font-semibold text-xs text-black">{recipe.createdAt}</p>
                </div>
              <div className="py-2">
            ...
            <div className="flex flex-col">
             ...
             <Link to="/recipeform"><button>Post recipe</button></Link>
           </div>
       }
     </div>
   </div>
